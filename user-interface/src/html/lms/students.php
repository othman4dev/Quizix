            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <ul class="nk-nav nav nav-tabs mt-n2">
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#student-info">student Info</a>
                        </li>
                            ...
                            <div class="row gy-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="full-name" placeholder="First name" name="username">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="display-name">nationality</label>
                                        <input type="text" class="form-control" id="display-name" placeholder="Last name" name="nationality">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="full-name">role-user</label>
                                        <input type="text" class="form-control" id="full-name" placeholder="role-user" name="role">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="full-name">password_user</label>
                                        <input type="text" class="form-control" id="full-name" placeholder="password_user" name="password">
                                    </div>
                                </div>
                                <div class="col-md-12">
