                              ...
                              <div class="card-inner">
                                <div class="card-title-group align-start mb-2">
                                  <div class="card-title">
                                    <h6 class="title">Student Progress</h6>
                                    <p>In last 30 days progress of student</p>
                                  </div>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <div class="nk-sale-data">
                                      <span class="amount"
                                        >8<span class="change up text-success"
                                          ><em
                                            class="icon ni ni-arrow-long-up"
                                          ></em
                                          >100%</span
                                        ></span
                                      >
                                      <span class="sub-title">Quizzes</span>
                                    </div>
                                  </div>
                                  <div class="nk-sales-ck sales-revenue">
                                    <canvas
                                      class="student-enrole"
                                      id="enrolement"
                                    ></canvas>
                                  </div>
                                </div>
                        ...
                        <div class="card h-100">
                          <div class="card-inner">
                            ...
                            <ul class="nk-top-products">
                                <?php 
                                  $sql2 = "SELECT * FROM cours ORDER BY cours.courId DESC LIMIT 5;";
                                  $result2 = $conn->query($sql2);
                                  while ($row2 = $result2->fetch_assoc()) {
                                    echo "
                                    <li class='item'>
                                    <div class='user-avatar sq bg-success-dim me-3'>
                                      <span>" .substr($row2["courName"], 0, 2). "</span>
                                    </div>
                                    <div class='info'>
                                      <div class='title'>
                                        ".$row2["courName"]."
                      ...
                      <div class="col-md-6 col-xxl-4">
                        <div class="card h-100">
                          <div class="card-inner">
                            <div class="card-title-group mb-2">
                              <div class="card-title">
                                <h6 class="title">Top Quizzes</h6>
                              </div>
                            </div>
                            <ul class="nk-top-products">
                              <?php 
                                  $sql3 = "SELECT * FROM quiz ORDER BY quiz.quizId DESC LIMIT 5;";
                                  $result3 = $conn->query($sql3);
                                  while ($row3 = $result3->fetch_assoc()) {
                                    echo "
                                    <li class='item'>
                                    <div class='user-avatar sq bg-danger-dim me-3'>
                                      <span>" .substr($row3["quizName"], 0, 2). "</span>
                                    </div>
                                    <div class='info'>
                                      <div class='title'>
                                        ".$row3["quizName"]."
