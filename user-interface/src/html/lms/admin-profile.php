...
<html lang="zxx" class="js">
  <head>
    ...
    <!-- Page Title  -->
    <title>Admin Profile | LMS | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                  ...
                                  <div class="dropdown">
                                    ...
                                    >
                                      <ul class="link-list-opt no-bdr">
                                        <li>
                                          <a href="../../../../quizix/auth/src/html/pages/auths/auth-login.php"
                                            ><em
                                              class="icon ni ni-camera-fill"
                                            ></em
                                            ><span>Change Acount</span></a
                                          >
                                        </li>
                                        <li>
                                          <a href="#"
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="personal">
                <div class="row gy-4">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="form-label" for="personal-email"
                        >Email</label
                      >
                      <input
                        type="email"
                        class="form-control"
                        id="personal-email"
                        value="otmankharbouch813@gmail.com"
                      />
                    </div>
                  </div>
                  <div class="col-md-6">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <select
                class="form-select js-select2 form-control form-control-lg"
                data-search="on"
              >
