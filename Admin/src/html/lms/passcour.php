...
<head>
  ...
  <script src="/src/html/lms/saveProgress.php"></script>
</head>

<body class="nk-body bg-lighter npc-default has-sidebar">
  <script>
    $(document).ready(function() {
      // Make an AJAX request to get the last saved scroll position
      $.ajax({
        type: 'GET',
        url: 'saveProgress.php?action=getScrollPosition&userId=1&courId=your_course_id',
        success: function(scrollPercentage) {
          // Scroll to the last saved position
          var targetScroll = (scrollPercentage / 100) * (document.documentElement.scrollHeight - window.innerHeight);
          $('html, body').animate({
        ...
        <div class="nk-sidebar-element nk-sidebar-head">
          <div class="nk-sidebar-brand">
            <a href="html/index.html" class="logo-link nk-sidebar-logo">
              <img class="logo-light logo-img" src="./images/logo.svg" srcset="./images/logo2x.png 2x" alt="logo" />
