...
<html lang="zxx" class="js">
  <head>
    ...
    <!-- Page Title  -->
    <title>Quizzes | LMS | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                          ...
                          if (isset($_GET["result"])) {
                            echo "
                                ...
                                <div class'dialog-r' style='position:fixed;background-color: #fff; display: flex; flex-direction: column; position: fixed; top: 50%; left: 50%; transform: translate(-50%,-50%); z-index: 5;padding:50px;border:solid 2px #9d72ff;'>
                                  ...
                                  <a href='html/lms/category.php'><button class='submit-it' style='width:100%;margin-top:25px'>Go To Quiz List</button></a>
                                </div>";
                          }
                          ?>
                          <!-- .nk-block-between -->
