...
if (isset($_POST["submit"])) {
    ...
    $query2 = "SELECT * FROM utilisateur WHERE email = '$email'";
    ...
    if (mysqli_num_rows($result2) > 0) {
        ...
        $query = "INSERT INTO utilisateur (userName, email, password_user) VALUES ( ?, ?, ? )";
                    ...
                    <div class="nk-split nk-split-page nk-split-lg">
                        <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white w-lg-45">
                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                                ...
                                <form action="html/pages/auths/auth-register.php" method="POST">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control form-control-lg" id="name" placeholder="Enter your full name"  name="username" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <a tabindex="-1" href="#" class="form-icon form-icon-right passcode-switch lg" data-target="New password">
                                ...
                                <div><?php echo $email_error ?><a href="auth-login.php"></div>
