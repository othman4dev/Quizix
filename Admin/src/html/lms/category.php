                ...
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand">
                        <a href="html/index.php" class="logo-link nk-sidebar-logo">
                            <img class="logo-light logo-img" src="./images/logo-dark.svg"
                                srcset="./images/logo2x.png 2x" alt="logo">
                            <img class="logo-dark logo-img" src="./images/logo.svg" srcset="./images/logo-dark2x.png 2x"
                                alt="logo-dark">
                            <img class="logo-small logo-img logo-img-small" src="./images/logo-small.svg"
                                    ...
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des text-soft">
                                                ...
                                                $sqlcode = "SELECT COUNT(*) FROM quiz";
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li class="nk-block-tools-opt d-none d-sm-block">
                                                            <a href="html/lms/AddCourseDetails.php"
                                            ...
                                            <div class="card-inner p-0">
                                                <table class="nk-tb-list nk-tb-ulist">
                                                            ...
                                                            <th class="nk-tb-col nk-tb-col-tools text-end">
                                                                <ul class="nk-tb-actions gx-1">
                                                                    <li>
                                                                        <div class="dropdown">
                                                                            <a
                                                                                class="btn btn-sm btn-trigger btn-icon dropdown-toggle">Actions</a>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            </th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                        $sql = "SELECT quiz.*, cours.*, administrateur.*
                                                      FROM quiz 
                                                      ...
                                                      ORDER BY quiz.quizId ASC;";
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            $quizID = $row["quizId"];
                                                            $tempsql = 'SELECT COUNT(*) FROM resultat WHERE quizId = ".$quizId."';
                                                            $result2 = mysqli_query($conn, $tempsql);
                    ...
                    <form action="#" class="pt-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex gx-3 mb-3">
                                ...
                                <div class="g">
                                    <button class="btn btn-icon btn-outline-light"><em
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <textarea class="form-control" name="description" id="edit-description"
                                    value="Website Design & Develop the website with web applications"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <ul class="d-flex justify-content-center gx-4 mt-4">
                            <li>
                                <button data-bs-dismiss="modal" id="deleteEvent" class="btn btn-success"
                                    onclick="sendDeleteId()">Yes, Delete it</button>
                            </li>
                            <li>
