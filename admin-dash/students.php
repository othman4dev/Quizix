                                ...
                                <ul class="nk-quick-nav">
                                    ...
                                    <li class="dropdown user-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end">
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    <li><a href="/Quizix/Admin/src/./logout.php"><em class="icon ni ni-signout"></em><span>Sign out</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                                ...
                                                                <div class='drodown'>
                                                                    ...
                                                                    <div class='dropdown-menu dropdown-menu-end'>
                                                                        <ul class='link-list-opt no-bdr'>
                                                                            <li><a href='./delete.php?userId=" . $row["userId"] . "' ><em class='icon ni ni-delete'></em><span>Delete User</span></a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </li>
