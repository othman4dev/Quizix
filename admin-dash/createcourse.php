                    ...
                    <li class="dropdown user-dropdown">
                      ...
                      >
                        ...
                        <div class="dropdown-inner">
                          <ul class="link-list">
                            <li>
                              <a href="html/user-profile-regular.php"
                                ><em class="icon ni ni-user-alt"></em
                                ><span>View Profile</span></a
                              >
                            </li>
                            <li>
                              <a href="html/user-profile-setting.php"
                                ><em class="icon ni ni-setting-alt"></em
                                ><span>Account Setting</span></a
                              >
                            </li>
                            <li>
                              <a href="html/user-profile-activity.php"
              ...
              <div class="nk-content-inner">
                <div class="nk-content-body">
                  <div class="content-page wide-md m-auto">
                    ...
                    <div class="nk-block">
                      <div class="card">
                        <form action="./controllers/add_course.php" method="post" id="form-add-course" class="course-form">
                        ...
                        <div class="quiz-pass">
                            <button class="add-head" onclick="addPart()">Add Chapter<img src="/user-interface/src/images/ex.svg" alt=""></button>
