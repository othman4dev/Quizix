...
var trafficSourcesElement = document.querySelector('#trafficSources');
var trafficSources = {
    labels: ["Administator", "Student"],
    dataUnit: 'People',
    legend: false,
    datasets: [{
        borderColor: "#fff",
        background: ["#9cabff", "#f9db7b"],
        data: Object.values(trafficSourcesElement.dataset)
    }]
};
