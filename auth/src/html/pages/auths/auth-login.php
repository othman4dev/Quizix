...
<head>
    ...
    <!-- Page Title  -->
    <title>Login | Quizix Admin Template</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Access the Quizix panel using your email and password.</p>
                                        </div>
                                    </div>
                                </div><!-- .nk-block-head -->
                                <form method="post" action="html/pages/auths/verifyLogin.php" class="form-validate is-alter" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input autocomplete="new-password" name="password" class="form-control form-control-lg" required id="password" placeholder="Enter your password">
                                        </div>
                                    </div><!-- .form-group -->
                                    <div class="form-group">
